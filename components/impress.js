...
const Impress = () => {
    return (
        <div className=' sm:px-16 py-8 flex flex-col items-center border space-y-4'>
            <p className='text-lg font-bold uppercase tracking-wider'>Actually built to Impress you</p>
            <div className='w-full sm:w-2/3 text-center text-lg tracking-wider px-4 '>
